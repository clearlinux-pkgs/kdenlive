...
Version  : 19.12.2
Release  : 9
URL      : https://github.com/KDE/kdenlive/archive/v19.12.2/kdenlive-19.12.2.tar.gz
Source0  : https://github.com/KDE/kdenlive/archive/v19.12.2/kdenlive-19.12.2.tar.gz
...
%prep
%setup -q -n kdenlive-19.12.2
cd %{_builddir}/kdenlive-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581019043
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdenlive-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/kdenlive/b1c25bcf0e44653a0ab61b5e3a5b2841414d0033
cp %{_builddir}/kdenlive-19.12.2/src/lib/external/kiss_fft/COPYING %{buildroot}/usr/share/package-licenses/kdenlive/a46324c99fbefcdfe04c19a35296ad219a256efb
pushd clr-build
%make_install
popd

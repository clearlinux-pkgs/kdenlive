...
Version  : 19.08.3
Release  : 6
URL      : https://github.com/KDE/kdenlive/archive/v19.08.3/kdenlive-19.08.3.tar.gz
Source0  : https://github.com/KDE/kdenlive/archive/v19.08.3/kdenlive-19.08.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573166431
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdenlive-19.08.3/COPYING %{buildroot}/usr/share/package-licenses/kdenlive/b1c25bcf0e44653a0ab61b5e3a5b2841414d0033
cp %{_builddir}/kdenlive-19.08.3/src/lib/external/kiss_fft/COPYING %{buildroot}/usr/share/package-licenses/kdenlive/a46324c99fbefcdfe04c19a35296ad219a256efb
pushd clr-build
%make_install
popd

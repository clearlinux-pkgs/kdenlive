...
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/kdenlive-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/kdenlive-22.04.3.tar.xz.sig
...
%prep
%setup -q -n kdenlive-22.04.3
cd %{_builddir}/kdenlive-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657593118
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdenlive-22.04.3/COPYING %{buildroot}/usr/share/package-licenses/kdenlive/1ca5712138d3e2539ee8cdfdf3c1c5cb693f5863
cp %{_builddir}/kdenlive-22.04.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/kdenlive/f1946dab78e58c04c8c25ec6b074f5fc5c2830fe
cp %{_builddir}/kdenlive-22.04.3/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kdenlive/3cb34cfc72e87654683f2894299adf912d14b284
cp %{_builddir}/kdenlive-22.04.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdenlive/3cb34cfc72e87654683f2894299adf912d14b284
cp %{_builddir}/kdenlive-22.04.3/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kdenlive/e3bdbf20d43fc066a1b40a64d57d4ae5a31f177f
cp %{_builddir}/kdenlive-22.04.3/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdenlive/e3bdbf20d43fc066a1b40a64d57d4ae5a31f177f
cp %{_builddir}/kdenlive-22.04.3/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kdenlive/49e61f7864169f2e356c11a17422d7d20d74b40f
cp %{_builddir}/kdenlive-22.04.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kdenlive/0d05dfdba8abf9192a31ac7ef555a76c10744d80
cp %{_builddir}/kdenlive-22.04.3/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/kdenlive/0d05dfdba8abf9192a31ac7ef555a76c10744d80
cp %{_builddir}/kdenlive-22.04.3/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdenlive/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/kdenlive-22.04.3/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdenlive/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd

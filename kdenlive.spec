...
Version  : 24.12.0
Release  : 70
URL      : https://download.kde.org/stable/release-service/24.12.0/src/kdenlive-24.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/kdenlive-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/kdenlive-24.12.0.tar.xz.sig
...
%setup -q -n kdenlive-24.12.0
cd %{_builddir}/kdenlive-24.12.0
pushd ..
cp -a kdenlive-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736358961
mkdir -p clr-build
pushd clr-build

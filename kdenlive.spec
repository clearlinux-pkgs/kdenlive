...
Version  : 24.05.2
Release  : 63
URL      : https://download.kde.org/stable/release-service/24.05.2/src/kdenlive-24.05.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/kdenlive-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/kdenlive-24.05.2.tar.xz.sig
Source2  : BB463350D6EF31EF.pkey
Summary  : A non-linear video editor for Linux using the MLT video framework
Group    : Development/Tools
License  : Apache-2.0 BSD-2-Clause BSD-3-Clause CC-BY-SA-4.0 CC0-1.0 GPL-2.0 GPL-3.0 LGPL-2.1 LGPL-3.0 MIT
...
%setup -q -n kdenlive-24.05.2
cd %{_builddir}/kdenlive-24.05.2
pushd ..
cp -a kdenlive-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720613551
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdenlive-%{version}/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kdenlive/fa05e58320cb7c64786b26396f4b992579a628bc || :
...
/usr/share/package-licenses/kdenlive/fa05e58320cb7c64786b26396f4b992579a628bc

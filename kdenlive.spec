...
Version  : 24.12.3
Release  : 73
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kdenlive-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kdenlive-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kdenlive-24.12.3.tar.xz.sig
Source2  : BB463350D6EF31EF.pkey
Summary  : A non-linear video editor for Linux using the MLT video framework
Group    : Development/Tools
License  : Apache-2.0 BSD-2-Clause BSD-3-Clause CC-BY-SA-4.0 CC0-1.0 GPL-2.0 GPL-3.0 LGPL-3.0 MIT
...
%setup -q -n kdenlive-24.12.3
cd %{_builddir}/kdenlive-24.12.3
pushd ..
cp -a kdenlive-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742528584
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdenlive-%{version}/.gitlab/issue_templates/Default.md.license %{buildroot}/usr/share/package-licenses/kdenlive/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4 || :
...
cp %{_builddir}/kdenlive-%{version}/LICENSES/Apache-2.0.txt %{buildroot}/usr/share/package-licenses/kdenlive/be561fe6eb626c2566b9a6c0885554b4ee4e6b74 || :
cp %{_builddir}/kdenlive-%{version}/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/kdenlive/07c1ab270255cf247438e2358ff0c18835b6a6ce || :
...
cp %{_builddir}/kdenlive-%{version}/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdenlive/0b71159e19bef95069e18d17296291916e89b5cd || :
...
cp %{_builddir}/kdenlive-%{version}/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/kdenlive/e458941548e0864907e654fa2e192844ae90fc32 || :
cp %{_builddir}/kdenlive-%{version}/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/kdenlive/adadb67a9875aeeac285309f1eab6e47d9ee08a7 || :
...
cp %{_builddir}/kdenlive-%{version}/src/lib/external/kiss_fft/README.md.license %{buildroot}/usr/share/package-licenses/kdenlive/7ff5a7dd2c915b2b34329c892e06917c5f82f3a4 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
...
/usr/share/kdenlive/effects/frei0r_kaleid0sc0pe.xml
...
/usr/share/kdenlive/effects/gpsgraphic.xml
...
/usr/share/kdenlive/scripts/vosk/speech.py
/usr/share/kdenlive/scripts/vosk/speechtotext.py
/usr/share/kdenlive/scripts/whisper/requirements-seamless.txt
/usr/share/kdenlive/scripts/whisper/requirements-whisper-windows.txt
/usr/share/kdenlive/scripts/whisper/requirements-whisper.txt
/usr/share/kdenlive/scripts/whisper/seamlessquery.py
/usr/share/kdenlive/scripts/whisper/whisperquery.py
/usr/share/kdenlive/scripts/whisper/whispertosrt.py
/usr/share/kdenlive/scripts/whisper/whispertotext.py
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/qt6/plugins/kf6/thumbcreator/mltpreview.so
/usr/lib64/qt6/plugins/kf6/thumbcreator/mltpreview.so

%files license
%defattr(0644,root,root,0755)
/usr/share/package-licenses/kdenlive/07c1ab270255cf247438e2358ff0c18835b6a6ce
/usr/share/package-licenses/kdenlive/0b71159e19bef95069e18d17296291916e89b5cd
...
/usr/share/package-licenses/kdenlive/adadb67a9875aeeac285309f1eab6e47d9ee08a7
/usr/share/package-licenses/kdenlive/be561fe6eb626c2566b9a6c0885554b4ee4e6b74

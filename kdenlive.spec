...
Version  : 19.08.0
Release  : 4
URL      : https://github.com/KDE/kdenlive/archive/v19.08.0/kdenlive-19.08.0.tar.gz
Source0  : https://github.com/KDE/kdenlive/archive/v19.08.0/kdenlive-19.08.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565989581
mkdir -p clr-build
pushd clr-build

...
Version  : 20.04.1
Release  : 14
URL      : https://github.com/KDE/kdenlive/archive/v20.04.1/kdenlive-20.04.1.tar.gz
Source0  : https://github.com/KDE/kdenlive/archive/v20.04.1/kdenlive-20.04.1.tar.gz
...
%prep
%setup -q -n kdenlive-20.04.1
cd %{_builddir}/kdenlive-20.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589852901
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdenlive-20.04.1/COPYING %{buildroot}/usr/share/package-licenses/kdenlive/b1c25bcf0e44653a0ab61b5e3a5b2841414d0033
cp %{_builddir}/kdenlive-20.04.1/src/lib/external/kiss_fft/COPYING %{buildroot}/usr/share/package-licenses/kdenlive/a46324c99fbefcdfe04c19a35296ad219a256efb
pushd clr-build
%make_install
popd
